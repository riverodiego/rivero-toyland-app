...
export default function Item(prod) {
    ...
    return (
        <Zoom key={prod.id} top>
            <Card style={{ minWidth: '14rem', maxWidth: '16rem', maxHeight: '40rem' }} className="m-3 text-center shadow">
                ...
                <Card.Footer>
                    ...
                    { prod.stock < 1 ? <Alert variant={"danger"}> Producto Sin Stock </Alert>
                                    :
